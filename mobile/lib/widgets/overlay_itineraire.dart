...
class OverlayItineraire extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color couleurScore =
        fournisseur.modeSecurise ? ThemeSafeRoute.vertSecurite : ThemeSafeRoute.orangeDanger;
                    ...
                    const Padding(
                      ...
                      child: Center(
                        child: Text(
                          ...
                          style:
                              TextStyle(color: ThemeSafeRoute.texteSecondaire),
                        ),
                      ),
                    )
                  else
                    ...fournisseur.instructions.asMap().entries.map((entry) {
                      final index = entry.key;
                      final step = entry.value;
                      final isFirst = index == 0;
                      final isLast =
                          index == fournisseur.instructions.length - 1;
                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                          color: Colors.white
                              .withValues(alpha: isFirst ? 0.04 : 0.01),
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                            ...
                            style: TextStyle(
                              color: ThemeSafeRoute.texteSecondaire
                                  .withValues(alpha: isFirst ? 1.0 : 0.7),
                              fontSize: 12,
                            ),
                          ),
                        ),
